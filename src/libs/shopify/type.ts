...
export type MailingAddressInput = Omit<MailingAddress , "countryCodeV2" | "formatted" | "formattedArea" | "id" | "name" | "provinceCode"> & { checked: boolean }
...
export type ShopifyCustomerDefaultAddressUpdate = {
    data: {
